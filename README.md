...
1. **Clone the repository**
   ```bash
   git clone https://github.com/usha123-boop/Customers-trends-data-analysis-SQL-Python-PowerBI.git
...
📺 Instagram: (https://www.instagram.com/_usha_asode/)
- Quick SQL tips, data memes, and behind-the-scenes content

💼 LinkedIn: (https://www.linkedin.com/in/ushaasode57/)
